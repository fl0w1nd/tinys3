    ...
    useEffect(() => {
        ...
        async function compressAndUpload() {
            try {
                ...
                const compressed = await compressWithTinyPng(
                    image.data,
                    preferences.tinypngApiKey
                );
    ...
    return (
        <Detail.Metadata>
            ...
            <Detail.Metadata.Label
                title="Original Size"
                text={prettyBytes(state.originalSize)}
            />
            <Detail.Metadata.Label
                title="Compressed Size"
                text={prettyBytes(state.compressedSize)}
            />
            <Detail.Metadata.Label
                title="Saved"
                text={savingsPercent(state.originalSize, state.compressedSize)}
            />
            {state.compressionCount && (
                <Detail.Metadata.Label
                    title="TinyPNG Count"
                    text={state.compressionCount}
                />
            )}
